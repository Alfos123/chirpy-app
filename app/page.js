...
export default function Home() {
  ...
  return (
    <main id="home">
      ...
      <section className="flex flex-col gap-0 items-center justify-center text-center py-0">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center gap-4">
            <button className="bg-red-200 border-red-900 text-red-800 px-3 py-1 rounded-3xl">
              Best CIMA TRAINING PARTNER IN GHANA
            </button>
            <h1 className="text-3xl font-bold w-250 text-white p-4">
              Smart Technology. Expert Tuition. Proven Pathways to First-Time PMP Success.
            </h1>
            ...
            <div className="flex gap-20 items-center p-3">
              <button className="bg-red-700 border-red-900 text-white font-bold px-3 py-2 rounded-1xl">
                EXPLORE CIMA PROGRAMS
              </button>
              <button className="border border-white text-white font-bold px-3 py-2 rounded-1xl">
                VISIT BOOKSTORE
              </button>
              <button className="text-bold text-white px-3 py-2 rounded-1xl">
                MAKE ENQUIRY
              </button>
            </div>
          </div>
      ...
      <section id="services" className="p-10 bg-blue-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-10 px-4 bg-blue-950 rounded-2xl">
          <div>
            ...
            <button className="bg-green-300 text-white px-4 py-2 rounded mt-4">GO TO CBE PLATFORM</button>
          </div>
          <div className="rounded-2xl overflow-hidden shadow-lg border border-gray-200 h-48 md:h-64">
            <img src="/images/PP2.avif" alt="Student resources" className="w-full h-full object-cover" />
          </div>
        </div>
      </section>
        ...
        <section className="bg-black text-white py-10 flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="#services" className="text-blue-800 hover:text-blue-500">Professional Services</a>
              <a href="#contact" className="text-blue-800 hover:text-blue-500">Training and Consultancy</a>
              <a href="#bookstore" className="text-blue-800 hover:text-blue-500">Bookstore</a>
            </div>
          </div>
          <div>
            <h3 className="text-lg font-semibold">Programs & Training</h3>
            <div className="flex flex-col gap-2">
              <a href="#about" className="text-blue-800 hover:text-blue-500">ICAG Professional</a>
              <a href="#services" className="text-blue-800 hover:text-blue-500">Corporate Training</a>
              <a href="#contact" className="text-blue-800 hover:text-blue-500">Executive Training</a>
            </div>
          </div>
          <div>
